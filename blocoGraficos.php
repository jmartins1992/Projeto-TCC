...
<html lang="pt-br">
    ...
    <head>
        ...
        <title>Gráficos em Blocos</title>
    ...
    <body style="background-color:#CDCDCD" >
        ...
        <div class="container-fluid bg-3 text-center">    
            ...
            <div class="row">
                <div class="col-sm-3">
                    <a href="graficoBloco1.php"><button type="button" class="btn btn-default btn-lg">Bloco 01-04
                            <span class="glyphicon glyphicon-th-large" aria-hidden="true"></span> 
                        </button>
                </div>

                <div class="col-sm-3"> 
                    <a href="graficoBloco2.php"><button type="button" class="btn btn-default btn-lg">Bloco 05-08
                            <span class="glyphicon glyphicon-th-large" aria-hidden="true"></span> 
                        </button>
                </div>

                <div class="col-sm-3"> 
                    <a href="graficoBloco3.php"><button type="button" class="btn btn-default btn-lg">Bloco 09-12
                            <span class="glyphicon glyphicon-th-large" aria-hidden="true"></span> 
                        </button>
                </div>

                <div class="col-sm-3">
                    <a href="graficoBloco4.php"><button type="button" class="btn btn-default btn-lg">Bloco 13-16
                            <span class="glyphicon glyphicon-th-large" aria-hidden="true"></span> 
                        </button>
                </div>
                ...
                <div class="container-fluid bg-3 text-center">    
                    ...
                    <div class="row">
                        <div class="col-sm-3">
                            <a href="graficoBloco5.php"><button type="button" class="btn btn-default btn-lg">Bloco 17-20
                                    <span class="glyphicon glyphicon-th-large" aria-hidden="true"></span> 
                                </button>
                        </div>
