...
<html lang="pt-br">
    ...
    <head>
        ...
        <title>Tela de Cadastro de Testemunha 3</title>
...
<div class="col-sm-8 text-left">
        ...
        $result_usuario = "INSERT INTO testemunha3 (valor3, data , hora) VALUES ('$valor','$data','$hora')";
        $resultado_usuario = mysqli_query($conn, $result_usuario);
        
        ?>
    

    <form class="form-horizontal" method="POST" action="cadastroTestemunha3.php" >
