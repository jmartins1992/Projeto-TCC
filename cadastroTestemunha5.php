...
<html lang="pt-br">
    ...
    <head>
        ...
        <title>Tela de Cadastro de Testemunha 5</title>
...
<div class="col-sm-8 text-left">
        ...
        $result_usuario = "INSERT INTO testemunha4 (valor5, data , hora) VALUES ('$valor','$data','$hora')";
        $resultado_usuario = mysqli_query($conn, $result_usuario);
        
        ?>
    

    <form class="form-horizontal" method="POST" action="cadastroTestemunha5.php" >
