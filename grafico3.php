...
<html lang="pt-br">
    ...
    <head>
        ...
        <title>Grafico Tensiometro 3</title>
    ...
    <body style="background-color:#A8A8A8">
        ...
        $query = "select sensor3, data ,TIME_FORMAT(time, '%h') 
        from tensiometro3 
            ...
            <div class="jumbotron" style="background-color:#A8A8A8">
                ...
                <script>
                    ...
                    function drawBackgroundColor() {
                        ...
                        data.addColumn('number', 'Tensiometro 3');
                       ...
                       //Opções do gráfico:		
                        var options = {
                            title: 'Gráfico de Leitura em Linhas Tensiomentro digital número 3.',
                            colors: ['red', 'blue'],
                            legend: 'top',
                            'width': 1100,
                            'height': 330,
