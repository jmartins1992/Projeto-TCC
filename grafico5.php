...
<html lang="pt-br">
    ...
    <head>
        ...
        <title>Grafico Tensiometro 5</title>
    ...
    <body style="background-color:#A8A8A8">
        ...
        $query = "select sensor5, data ,TIME_FORMAT(time, '%h') 
        from tensiometro5 
            ...
            <div class="jumbotron" style="background-color:#A8A8A8">
                ...
                <script>
                    ...
                    function drawBackgroundColor() {
                        ...
                        data.addColumn('number', 'Tensiometro 5');
                        ...
                        //Opções do gráfico:		
                        var options = {
                            title: 'Gráfico de Leitura em Linhas Tensiomentro digital número 5.',
                            colors: ['red', 'blue'],
                            legend: 'top',
                            'width': 1100,
                            'height': 330,
        ...
        <div  style="background-color:#000000">
            ...
            <form method="POST" action="grafico5.php" >
