...
<html lang="pt-br">
    ...
    <head>
        ...
        <title>Grafico Tensiometro 9</title>
    ...
    <body style="background-color:#A8A8A8">
        ...
        $query = "select sensor9, data ,TIME_FORMAT(time, '%h') 
        from tensiometro9 
            ...
            <div class="jumbotron" style="background-color:#A8A8A8">
                ...
                <script>
                    ...
                    function drawBackgroundColor() {
                        ...
                        data.addColumn('number', 'Tensiometro 9');
                        ...
                        //Opções do gráfico:		
                        var options = {
                            title: 'Gráfico de Leitura em Linhas Tensiomentro digital número 9.',
                            colors: ['red', 'blue'],
                            legend: 'top',
                            'width': 1100,
                            'height': 330,
