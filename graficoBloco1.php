...
<html lang="pt-br">
    ...
    <head>
        ...
        <title>Grafico da leitura em Bloco do Tensiomentro 1 até o 4</title>
    ...
    <body style="background-color:#CDCDCD">
        ...
        $query = "select TIME_FORMAT(time, '%h') , sensor1 , sensor2 , sensor3 , sensor4
        from viewBloco1 where data like '$data' 
        ...
        $tens_hora[] = ((string) $linha['$hora']);

        $tens_hora[] = ((float) $linha['sensor1']);
        ...
        <div  style="background-color:#FF0000">
            ...
            <form method="POST" action="graficoBloco1.php" >
