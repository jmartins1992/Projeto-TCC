...
<html lang="pt-br">
    ...
    <head>
        ...
        <title>Grafico da leitura em Bloco do Tensiomentro 5 até o 8</title>
    ...
    <body style="background-color:#CDCDCD">
        ...
        $query = "select TIME_FORMAT(time, '%h') , sensor5 , sensor6 , sensor7 , sensor8
        from viewBloco2 where data like '$data' 
        ...
        $tens_hora[] = ((float) $linha['sensor5']);
        $tens_hora[] = ((float) $linha['sensor6']);
        $tens_hora[] = ((float) $linha['sensor7']);
        $tens_hora[] = ((float) $linha['sensor8']);
            ...
            <div class="jumbotron" style="background-color:#CDCDCD">
                ...
                <script>
                    ...
                    function drawBackgroundColor() {
                        ...
                        data.addColumn('number', 'Tensiometro5');
                        data.addColumn('number', 'Tensiometro6 ');
                        data.addColumn('number', 'Tensiometro7 ');
                        data.addColumn('number', 'Tensiometro8 ');
        ...
        <div  style="background-color:#FF0000">
            ...
            <form method="POST" action="graficoBloco2.php" >
