...
<html lang="pt-br">
    ...
    <head>
        ...
        <title>Grafico da leitura em Bloco do Tensiomentro 9 até o 12</title>
    ...
    <body style="background-color:#CDCDCD">
        ...
        $query = "select TIME_FORMAT(time, '%h') , sensor9 , sensor10 , sensor11 , sensor12
        from viewBloco3 where data like '$data' 
        ...
        $tens_hora[] = ((float) $linha['sensor9']);
        $tens_hora[] = ((float) $linha['sensor10']);
        $tens_hora[] = ((float) $linha['sensor11']);
        $tens_hora[] = ((float) $linha['sensor12']);
            ...
            <div class="jumbotron" style="background-color:#CDCDCD">
                ...
                <script>
                    ...
                    function drawBackgroundColor() {
                        ...
                        data.addColumn('number', 'Tensiometro9');
                        data.addColumn('number', 'Tensiometro10 ');
                        data.addColumn('number', 'Tensiometro11');
                        data.addColumn('number', 'Tensiometro12');
        ...
        <div  style="background-color:#FF0000">
            ...
            <form method="POST" action="graficoBloco3.php" >
