...
<html lang="pt-br">
    ...
    <head>
        ...
        <title>Grafico da leitura em Bloco do Tensiomentro 13 até o 16</title>
    ...
    <body style="background-color:#CDCDCD">
        ...
        $query = "select TIME_FORMAT(time, '%h') , sensor13 , sensor14 , sensor15 , sensor16
        from viewBloco4 where data like '$data' 
        and time between '$hora' and '$hora2'; ";
        ...
        $tens_hora[] = ((float) $linha['sensor13']);
        $tens_hora[] = ((float) $linha['sensor14']);
        $tens_hora[] = ((float) $linha['sensor15']);
        $tens_hora[] = ((float) $linha['sensor16']);
        ...
        ?>
               ...
               <nav class="navbar navbar-inverse" style="background-color:#FF0000" >
            ...
            <div class="jumbotron" style="background-color:#CDCDCD">
                ...
                <script>
                    ...
                    function drawBackgroundColor() {
                        ...
                        data.addColumn('number', 'Tensiometro13');
                        data.addColumn('number', 'Tensiometro14');
                        data.addColumn('number', 'Tensiometro15');
                        data.addColumn('number', 'Tensiometro16');
        ...
        <div  style="background-color:#FF0000">
            ...
            <form method="POST" action="graficoBloco4.php" >
