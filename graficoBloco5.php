...
<html lang="pt-br">
    ...
    <head>
        ...
        <title>Grafico da leitura em Bloco do Tensiomentro 17 até o 20</title>
    ...
    <body style="background-color:#CDCDCD">
        ...
        $query = "select TIME_FORMAT(time, '%h') , sensor17 , sensor18 , sensor19 , sensor20
        from viewBloco5 where data like '$data' 
        ...
        $tens_hora[] = ((float) $linha['sensor17']);
        $tens_hora[] = ((float) $linha['sensor18']);
        $tens_hora[] = ((float) $linha['sensor19']);
        $tens_hora[] = ((float) $linha['sensor20']);
            ...
            <div class="jumbotron" style="background-color:#CDCDCD">
                ...
                <script>
                    ...
                    function drawBackgroundColor() {
                        ...
                        data.addColumn('number', 'Tensiometro17');
                        data.addColumn('number', 'Tensiometro18');
                        data.addColumn('number', 'Tensiometro19');
                        data.addColumn('number', 'Tensiometro20');
        ...
        <div  style="background-color:#FF0000">
            ...
            <form method="POST" action="graficoBloco5.php" >
