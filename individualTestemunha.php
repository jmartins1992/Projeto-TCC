...
<html lang="pt-br">
    ...
    <head>
        ...
        <title>Tabela de dados da Testemunha </title>
    ...
    <body style="background-color:#CDCDCD">
        ...
        <nav class="navbar navbar-inverse" style="background-color:#FFFF00">
        ...
        <div class="container-fluid bg-3 text-center">    
            ...
            <div class="row">
                <div class="col-sm-3">
                    <a href="tabelaTestemunha1.php"><button type="button" class="btn btn-default btn-lg">Testemunha 1
                            <span class="glyphicon glyphicon-list-alt" aria-hidden="true"></span> 
                        </button>
                </div>

                <div class="col-sm-3"> 
                    <a href="tabelaTestemunha2.php"><button type="button" class="btn btn-default btn-lg">Testemunha 2
                            <span class="glyphicon glyphicon-list-alt" aria-hidden="true"></span> 
                        </button>
                </div>

                <div class="col-sm-3"> 
                    <a href="tabelaTestemunha3.php"><button type="button" class="btn btn-default btn-lg">Testemunha 3
                            <span class="glyphicon glyphicon-pencil" aria-hidden="true"></span> 
                        </button>
                </div>

                <div class="col-sm-3">
                    <a href="tabelaTestemunha4.php"><button type="button" class="btn btn-default btn-lg">Testemunha 4
                            <span class="glyphicon glyphicon-list-alt" aria-hidden="true"></span> 
                        </button>
                </div>
                ...
                <div class="col-sm-3">
                    <a href="tabelaTestemunha5.php"><button type="button" class="btn btn-default btn-lg">Testemunha 5
                            <span class="glyphicon glyphicon-list-alt" aria-hidden="true"></span> 
                        </button>
                </div>
