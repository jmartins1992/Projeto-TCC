...
<html lang="pt-br">
    ...
    <head>
        ...
        <title>Tela de Dados em Tabela referente ao Tensiometro 15</title>
    ...
    <body style="background-color:#A8A8A8">
        ...
        <div class="jumtron">
            <div class="container text-center" style="background-color:#CDCDCD">
                ...
                $query = "select id , time , sensor15, data ,TIME_FORMAT(time, '%h') 
                from tensiometro15 
                ...
                if (mysqli_num_rows($resultado) > 0) {
                    ...
                    while ($info = mysqli_fetch_array($resultado)) {
                        print "<tr><td>$info[id]</td> <td>$info[data]</td> <td>$info[time]</td> <td>$info[sensor15]</td></tr>";
                    }
                    print "</table>";
                }
                ?>
        ...
        <div  style="background-color:#6B238E">
            ...
            <form method="POST" action="tabela15.php" >
