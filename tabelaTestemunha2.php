...
<html lang="pt-br">
    ...
    <head>
        ...
        <title>Tela de Dados em Tabela da Testemunha 2</title>
    ...
    <body style="background-color:#A8A8A8">
        ...
        <div class="jumtron">
            ...
            <div class="container text-center" style="background-color:#CDCDCD">
                ...
                $query = "select id , hora , valor2, data ,TIME_FORMAT(hora, '%h') 
                from testemunha2 
                where data like '$data' and hora between '$hora' and '$hora2' ";
                ...
                if (mysqli_num_rows($resultado) > 0) {
                    ...
                    while ($info = mysqli_fetch_array($resultado)) {
                        print "<tr><td>$info[id]</td> <td>$info[data]</td> <td>$info[hora]</td> <td>$info[valor]</td></tr>";
                    }
                    print "</table>";
                }
                ?>
        ...
        <div style="background-color:#FFFF00">
            ...
            <form method="POST" action="tabelaTestemunha2.php" >
